...
Let sellers turn 'Free shipping' on or off for each listing. This task tracks the work required to implement, test, and deploy this capability as described in the sprint plan.
