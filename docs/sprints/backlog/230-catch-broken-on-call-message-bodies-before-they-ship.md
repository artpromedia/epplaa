...
Catch broken on-call message bodies before they ship. This task tracks the work required to implement, test, and deploy this capability as described in the sprint plan.
